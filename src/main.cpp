...
uint256 hashGenesisBlock("0x17d19424f1db94fd9381910703da15400fc80c5a4ff4720ff28fcf5eed30c0ce");
...
const string strMessageMagic = "bsacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // bsacoin: 1 days
static const int64 nTargetSpacing = 120; // bsacoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bsacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bsacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbe411980ce6df97efe41b13602e83d117a2c842d10db4b27610481f20ebc931b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 10th, 2014 - It is born...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394567050; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2399430;

        if (fTestNet)
        {
            block.nTime    = 1394483384;
            block.nNonce   = 1347718;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4a53bebd4ac175a53387664b66dfb781f79ec8119376b1b8cdbaed48e34eecb4"));
