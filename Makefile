...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Thu Mar 13 10:57:56 2014
...
LIBS          = -L./lib -W1,-R./lib '-W1,-R$$ORIGIN' -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
